package net.awakenedredstone.nbttooltip.gui;
...
public class GuiConfigs extends GuiConfigsBase {
    ...
    public GuiConfigs() {
        super(10, 50, "nbttooltip", null, "nbttooltip.gui.title.configs");
    }
    ...
    public enum ConfigGuiTab {
        SETTINGS("nbttooltip.gui.button.config_gui.settings"),
        HOTKEYS("nbttooltip.gui.button.config_gui.hotkeys"),
        LISTS("nbttooltip.gui.button.config_gui.lists");
